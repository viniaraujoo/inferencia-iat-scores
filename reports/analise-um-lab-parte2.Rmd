...
Em média, as mulheres que participaram do experimento tiveram uma associação implícita (medida pelo IAT) com a matemática **negativa** e **média** (**média 0.415, desv. padrão 0.537, N = 69**). Homens tiveram uma associação **negativa** com a matemática, portanto **menor** que a das mulheres (**média 0.229 , desv. padrão 0.584, N = 26**). Houve portanto uma **pequena** diferença entre homens e mulheres (**diferença das médias -0.1859866, 95% CI [-0.4199064, 0.1061985]**). Os dados de nosso experimento apontam que a partir dessa amostra,mulheres têm uma associação negativa mais forte, porém não é claro se essa diferença é grande, moderada ou pequena. É necessário coletar mais dados para determinar se a diferença é relevante ou negligenciável
